...
type1_mid_gan_df = pd.read_csv("new_data/docs/gpt35_type1_mid_gan_dataset.csv", encoding="utf-8-sig")
type1_low_gan_df = pd.read_csv("new_data/docs/gpt35_type1_low_gan_dataset.csv", encoding="utf-8-sig")
...
type1_merge_gpt35_df.to_csv('new_data/docs/Final_GPT35/gpt35_type1_merge_train_dataset.csv', index=False, encoding="utf-8-sig")


type2_mid_gan_df = pd.read_csv("new_data/docs/gpt35_type2_mid_gan_dataset.csv", encoding="utf-8-sig")
type2_low_gan_df = pd.read_csv("new_data/docs/gpt35_type2_low_gan_dataset.csv", encoding="utf-8-sig")
...
type2_merge_gpt35_df.to_csv('new_data/docs/Final_GPT35/gpt35_type2_merge_train_dataset.csv', index=False, encoding="utf-8-sig")
