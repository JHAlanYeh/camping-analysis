...
mid_gan_df = pd.read_csv("new_data/docs_0819/Final_TaiwanLLM/taiwanllm_type2_prompt_easy_mid_gan_dataset.csv", encoding="utf-8-sig")
low_gan_df = pd.read_csv("new_data/docs_0819/Final_TaiwanLLM/taiwanllm_type2_prompt_easy_low_gan_dataset.csv", encoding="utf-8-sig")
...
merge_df.to_csv('new_data/docs_0819/Final_TaiwanLLM/taiwanllm_type2_prompt_easy_gan_df.csv', index=False, encoding="utf-8-sig")
