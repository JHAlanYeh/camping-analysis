...
type1_mid_gan_df = pd.read_csv("new_data/docs/llama3_type1_mid_gan_df.csv", encoding="utf-8-sig")
type1_low_gan_df = pd.read_csv("new_data/docs/llama3_type1_low_gan_df.csv", encoding="utf-8-sig")
...
type1_merge_llama3_df.to_csv('new_data/docs/llama3_type1_merge_df.csv', index=False, encoding="utf-8-sig")


type2_mid_gan_df = pd.read_csv("new_data/docs/llama3_type2_mid_gan_df.csv", encoding="utf-8-sig")
type2_low_gan_df = pd.read_csv("new_data/docs/llama3_type2_low_gan_df.csv", encoding="utf-8-sig")
...
type2_merge_llama3_df.to_csv('new_data/docs/llama3_type2_merge_df.csv', index=False, encoding="utf-8-sig")
