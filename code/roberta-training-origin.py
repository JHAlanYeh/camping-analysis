...
def prprocess_data():
    min_num = 999999
    df1 = pd.read_csv("../docs/gan/type_origin.csv", encoding="utf_8_sig")
...
def draw_loss_image(loss_list, loss_val_list):
    ...
    plt.xlabel('Epoches')
    plt.legend()
    plt.savefig("../model/origin_type1/roberta_loss.jpg")
...
def draw_acc_image(accuracy_list, accuracy_val_list):
    ...
    plt.xlabel('Epoches')
    plt.legend()
    plt.savefig("../model/origin_type1/roberta_acc.jpg")
