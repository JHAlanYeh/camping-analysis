...
if __name__ == "__main__":
    ...
    # pd.DataFrame(df_train, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_Origin/Type1_Result/train_df.csv", index=False)
    # pd.DataFrame(df_val, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_Origin/Type1_Result/val_df.csv", index=False)
    # pd.DataFrame(df_test, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_Origin/Type1_Result/test_df.csv", index=False)
