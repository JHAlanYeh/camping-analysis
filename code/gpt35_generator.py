...
df = pd.read_csv("new_data\\docs_0804\\Final_Origin\\Type1_Result\\train_df_3.csv", encoding="utf-8-sig")
...
df_low_gan_csv = pd.read_csv("new_data/docs_0804/gpt35_type1_low_gan_train_df_3.csv", encoding="utf-8-sig")
df_low_gan_csv[['sequence_num']] = df_low_gan_csv[['sequence_num']].astype(int)

df_mid_gan_csv = pd.read_csv("new_data/docs_0804/gpt35_type1_mid_gan_train_df_3.csv", encoding="utf-8-sig")
...
while len(df_low) + len(df_low_gan) < target_count:
    ...
    for index, row in df_low.iterrows():
        ...
        low_gan_df.to_csv('new_data/docs_0804/gpt35_type1_low_gan_train_df_3.csv', index=False, encoding="utf-8-sig")
...
while len(df_mid) + len(df_mid_gan) < target_count:
    ...
    for index, row in df_mid.iterrows():
        ...
        mid_gan_df.to_csv('new_data/docs_0804/gpt35_type1_mid_gan_train_df_3.csv', index=False, encoding="utf-8-sig")
