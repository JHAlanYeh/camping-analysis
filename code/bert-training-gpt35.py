...
def preprocess_data():
    df = pd.read_csv("new_data/docs/Final_GPT35/gpt35_type2_merge_df.csv", encoding="utf_8_sig")
...
if __name__ == "__main__":
    ...
    pd.DataFrame(df_train, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_GPT35/Type2_Result/train_df.csv", index=False)
    pd.DataFrame(df_val, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_GPT35/Type2_Result/val_df.csv", index=False)
    pd.DataFrame(df_test, columns=["content", "status", "type", "label"]).to_csv("new_data/docs/Final_GPT35/Type2_Result/test_df.csv", index=False)
