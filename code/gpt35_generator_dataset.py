...
all_df = pd.read_csv("new_data/docs/gpt35_type1_merge_df.csv")
...
for index, row in df_low.iterrows():
    ...
    low_gan_df.to_csv('new_data/docs/gpt35_type1_low_gan_dataset.csv', index=False, encoding="utf-8-sig")
...
for index, row in df_mid.iterrows():
    ...
    mid_gan_df.to_csv('new_data/docs/gpt35_type1_mid_gan_dataset.csv', index=False, encoding="utf-8-sig")
