...
while len(df_low) + len(df_low_gan) < target_count:
    ...
    for index, row in df_low.iterrows():
        ...
        low_gan_df.to_csv('new_data/docs_0819/breeze_type2_low_gan_dataset.csv', index=False, encoding="utf-8-sig")
...
while len(df_mid) + len(df_mid_gan) < target_count:
    ...
    for index, row in df_mid.iterrows():
        ...
        mid_gan_df.to_csv('new_data/docs_0819/breeze_type2_mid_gan_dataset.csv', index=False, encoding="utf-8-sig")
